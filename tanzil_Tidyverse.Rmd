---
title: "Chess Transfers Data Analysis with Tidyverse"
author: "Tanjil"
date: "`r Sys.Date()`"
...
chess_df <- read_csv("C:\\Users\\tanzi\\OneDrive\\DATA\\607\\Extra Credit\\Tiddyverse\\Tidyverse\\chess_transfers.csv")
...
top_federations <- chess_df %>%
  count(Form.Fed, sort = TRUE) %>%
  slice_max(n, n = 10)

ggplot(top_federations, aes(x = reorder(Form.Fed, n), y = n)) +
